...
define([
	...
	/**
	 * @name orion.edit.LiveEditorContext
	...
	/**
	 * Gets the live editor context service.
	 * @name orion.edit.LiveEditorContext.getEditorContext
	 * @function
	 * @param {orion.serviceregistry.ServiceRegistry} serviceRegistry The service registry to consult.
	 * @returns {orion.edit.LiveEditorContext}
	 */
	 ...
	 * @name orion.edit.LiveEditorContext.getOptions
	 * @function
	 * @param {orion.serviceregistry.ServiceRegistry} serviceRegistry The service registry to consult.
	 * @returns {Object}
	 */
	...
	function getReferences(serviceRegistry) {
		return serviceRegistry.getServiceReferences("orion.edit.liveContext"); //$NON-NLS-0$
	}
